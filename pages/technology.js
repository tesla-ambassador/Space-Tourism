...
export default function Technology() {
  ...
  return (
    <div className='techBg h-screen tab:h-fit flex items-center justify-center dsk:overflow-hidden dsk:h-screen xdsk:h-fit'>
        <div className='flex flex-col items-center w-full gap-3 mt-24 tab:mt-48 xdsk:px-40 xdsk:py-20 xdsk:pr-0'>
            <div className='tab:self-start px-10'>
                <PageTitle 
                    number='03'
            ...
            <div className='flex flex-col items-center gap-3 mt-10 dsk:flex-row-reverse dsk:justify-between'>
                <motion.div className='w-full tab:w-fit dsk:w-full'
                initial={{opacity: 0}}
                animate={{opacity: 1}}
                transition={{
                    duration: .5,
